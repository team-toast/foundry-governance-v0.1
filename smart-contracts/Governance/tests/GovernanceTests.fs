...
let ``Governator can not degovernate if user does not have sufficient gFry balance`` () =
    ...
    let amountOfgFryToDegovernate = bigint 500 // This is more than the use has

    //printfn "gFryBalanceBeforeDegovernate: %O" gFryBalance
    ...
    //printfn "gFryBalanceAfterDegovernate: %O" gFryBalanceAfterDegovernate
